...
-- AMIS
CREATE TABLE ami (
	IdAmi				INT				NOT NULL GENERATED BY DEFAULT AS IDENTITY,
	personne1		INT 	NOT NULL,
	personne2		    INT  	NOT NULL,
	date_anciennete     VARCHAR(50)		NOT NULL,
	FOREIGN KEY (personne1) REFERENCES personne (IdPersonne),
	FOREIGN KEY (personne2) REFERENCES personne (IdPersonne),
	PRIMARY KEY (idAmi)
);
